...
function leaveHomeCard(){
  ...
  return `<div class="card leave-home-card" onclick="go('leave')" role="button" tabindex="0"><div class="leave-home-main"><div class="leave-home-ico">I</div><div class="leave-home-copy"><div class="label">Izin Staff</div><div class="leave-home-title">${lock?'Fitur dikunci admin':(pendingRow?'Izin menunggu admin':'Ajukan izin sakit / keperluan')}</div><div class="hint">${esc(latestLine)}</div></div></div><div class="leave-home-actions">${primary}</div></div>`;
}
